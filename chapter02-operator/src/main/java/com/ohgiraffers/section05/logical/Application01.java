...
public class Application01 {
    public static void main(String[] args) {
        /*
         * 논리 연산자
         * 논리값(true||false)를 추급하는 연산자이다.
         *
         * 논리 연산자의 종류
         * 1. 논리 연결 연산자 : 두 개의 피연산자를 가지는 이항 연산자이며, 연산자의 결합 방향은 왼쪽에서ㅓ 오른쪽이다. 두 개의 논리식을 판단하여 참과 거짓을 판단
         ...
         * 2. 논리 부정 연산자 : 피연산자가 하나의 단항연산자로,피연산자으 결합 방향은 왼쪽에서 오른쪽이다
         *   2-1. !(논리 not): 논리식의 결과 가 참이면 거짓, 거짓이면 참을 반환한다
         * */
