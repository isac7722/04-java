...
public class B_ifElseif {
    ...
    public static void main(String[] args) {
        B_ifElseif app1 = new B_ifElseif();
        app1.testNestedIfElseIfstatement();
    }

    public void testSimpleIfElseIfStatement(){
        /*금도끼 은도끼 동화에서 산신령이 어떤 도끼가 나무꾼의 도끼인지 물어보는 시나리오 코드를 만들어 보자*/
    ...
    public void testNestedIfElseIfstatement(){
        ...
        System.out.println(name+"학우님의 등급은 "+grade+"입니다");
