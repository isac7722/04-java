...
public class Application01 {
    ...
    public static void main(String[] args){
        ...
        * 자바에서 컬렉션 프레임워크는 여러 개의 다양한 데이터들을 쉽고 효과적으로 처리할 수 있도ㅗ록
        ...
        * 3. Map 인터페이스
        *
        * list 인터페이스와 set 인터페이스의 공통 부분을 collection 인터페이스에서 정의하고ㅗ 있다.
        ...
        *
        * 2. set 인터페이스
        *   - 숭서가 없는 데이터의 집합으로 데이터의 중복을 허용하지 않는다.
        *   - hashMap, TreeSet 등이 있다.
        * 3. Map 인터페이스
        *   - 키와 값 한 쌍으로 이우러지는 데이터의 집합이다.
        *   - key를 set 방식으로 관리하기 때문에 데이터의 순서를 관리하지 않고 중복된 key를 허용하지 않느다.
        ...
        *
        * ArrayList
        * 가장 많이 사용되는 컬렉션 클ㄹ래스이다.
        * jdk1.2 부터 제공되고 있다.
        * 내부적으로 배열을 이용하여 요소를 관리하며 인덱스를 이용해 배열 요소에 빠르게 접근할 수 잇다.
        *
        * ArrayList는 배열의 단점을 보완하기 위해 만들어졌다.
        * 배열은 크기를 변경할 수 없고, 요소 추가, 삭제, 정렬 등이 복잡하다는 단점을 가지고있다.
...
//        stringList.add(String.valueOf(1234));
        ...
        * 인덱스를 사용하지 않고도 반복문을 사용하기 위한 목록을 만들어주는 역할이라고 보ㅗ면된다.
