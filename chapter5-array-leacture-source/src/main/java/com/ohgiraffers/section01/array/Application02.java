...
//        array[0] = 10;
        ...
        * new 연산자는 heap 영역에 공간을 할당하고 발생한 주소값을 반환하니ㅡㄴ 연사자이다
        * 발생한 주소를 래퍼런스 변수(참조 변수)에 저장하여 이것을 사용하기 떄문에 참조자료형이라고 한다
        * */
//
//        iarray = new int[5];
//        array = new int[10];
...
//        test[0] = 100;
        ...
        * stack에 저장된 주소로 heap에 할당된 배열을 앚아갈 수 있다
        * */
//
...
//        * 동일객체인지 비교할 때 사용할 목적을 쓰여지며, 동등객체를 동리 객체 취급하기 위한 용도로 ovrring해서 사용한다
//        * */
//
...
//        System.out.println(test[0]);
        ...
        System.out.println("darr 의 hashcod: "+darr.hashCode());
