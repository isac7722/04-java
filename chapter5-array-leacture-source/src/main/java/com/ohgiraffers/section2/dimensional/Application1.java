package main.java.com.ohgiraffers.section2.dimensional;

public class Application1 {
    public static void main(String[] args) {
        /*
        * 다차원 배열
        * 다차원 배열은 2차원 이상의 배열을 의미한ㄷ.
        *
        * 배열의 인덱스마다 또 다른 배열의 주소를 보관하는 배열을 의민한다.
        * 2ㅡㄱ, 2차원 배열은 1차원 배열 여러 개를 하나로 묶어서 고나리하는 배열을 의미한다.
        * 더 많은 차원의 배열을 사용할 수 있지만 일반적으로 2차원 배열보다 더 높은 차원의 배열은 사용빈도가 적다
        *
        * 2차원 배열을 사용하는 방법
        * 1. 배열의 주소를 보관할 래퍼런스 변수를 선언
        * 2. 여러개의 1차원 배열의 주소를 관리하는 배열을 생성
        * 3. 각 인덱서ㅡ에서 관리하는 배열을 할당하여 주소를 보관하는 배열에 저장
