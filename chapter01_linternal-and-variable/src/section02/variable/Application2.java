...
public class Application2 {
    public static void main(String[] args){
        ...
        * 그 중 기본 자료형 8가지를 먼저 확인하다.
        * */

        // 목차 1-1-1 숫자를 취급하는 자료형
        // 1byte는 8개의 bit가 모여진 데이터 단위이다.
        // 1bit는 0과 1 중 하나의 값만을 가질 수 있는 데이터의 최소 단위이다.
        ...
        boolean isTrue; // 1byte 논리 데이터 형은 0과 1의 값으로 데이터를 취급하기 때문에 1bit로 표현이 가능하지만 최소 단위가 1 byte이기 때문에 1byte의 크기를 갖는다.

        // 기본자료형  -> 원시 데이터라고도 불린다.
        // 한글은 유니코드 체계를 통해서 찾아봐라.
        ...
        * 만약, 약 내용과 다른 형태의 값을 대입하려고 한다면 Compiler는 에러를 발생시킨다
        *
        * 설명
        * 대입 연산자의 실행 방향은 오른쪽에서 왼쪽이다
        * 즉 오른 쪽에 있는 값을 왼쪽의 공간에 대입한다는 의미이며, 왼쪽에는 항상 공간, 오른쪽에는 항상 값이 온다..
       ...
       // fnum = 4.0; // 실수 형태의 값을 fnum에 사용하는 것은 불가능하다.
        ...
        ch ='a';        // 아스키 코드표에 참조하여 문자는 연산시 숫자로 변환된다.
        char ch2 = 97;  // 아스키 코드표에 참조하여 숫자를 문자로 대입시 자료형에 따라 문자로 변환된다.
        ...
        /*
        * 슷지러 된 형태의 값을 그대로 사용하는 자료형은 byte, short, int, double이다
