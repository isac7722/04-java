...
public class Application3 {
    public static void main(String[] args){
        /*
        * 변수의 명명 규칙
        * 변수의 이름을 지을 때 아무렇게나 짓는 것이 아닌 정해진 규칙이 ㅇㅆ다
        ...
        * 변수의 명명 규칙
        * 1. 컴파일 에러를 발생시키는 규칙
        *   1-1. 동일한 범위 내에서는 동일 한 변수명을 가질 수 없다.
        *   1-2. 예약어는 사용이 불가능하다(예약이란 프로그램에서 미리 사용하겠다고 compiler와 약속한 키워드를 예약어라고 한다.
        *   1-3. 변수명은 대/소문자를 구분한다. (자바는 대/소문자를 엄격하게 구분하는 언어이다.)
        *   1-4. 변수명은 숫자로 시작할 수 없ㄷ. (시작하는 것만 불가능 하고 숫자를 섞어서 사용하는 것은 가능하다.)
        ...
        *   2-8. boolean형은 의문문으로 가급ㅈ거 긍정형태로 네이밍한다.
        * */
...
//        int test* = 10;
        ...
        // 2-1 에러를 발생시키지는 않지만 개발자 끼리의 암묵적인 규칙
        int dflkanfdlkafladjhfiaouvovuhavudiaodhdviahoadfafdafda;
        ...
        // 2-5 변수 안에 저장된 값이 어던 의미를 가지는지 명확하게 표현하도록 한다.
        String s;
        String name;
